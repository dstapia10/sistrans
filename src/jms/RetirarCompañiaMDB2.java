...
public class RetirarCompañiaMDB2 implements MessageListener, ExceptionListener 
{
	public final static int TIME_OUT = 10;
	private final static String APP = "app2";
	
	private final static String GLOBAL_TOPIC_NAME = "java:global/RMQTopicRetirarCompañia";
	private final static String LOCAL_TOPIC_NAME = "java:global/RMQRetirarCompañia";
	...
	public RetirarCompañiaMDB2(TopicConnectionFactory factory, InitialContext ctx) throws JMSException, NamingException 
	{	
