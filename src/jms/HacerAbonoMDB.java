...
public class HacerAbonoMDB implements MessageListener, ExceptionListener 
{
	public final static int TIME_OUT = 10;
	private final static String APP = "app2";
	
	private final static String GLOBAL_TOPIC_NAME = "java:global/RMQTopicAbono";
	private final static String LOCAL_TOPIC_NAME = "java:global/RMQAbono";
	...
	public HacerAbonoMDB(TopicConnectionFactory factory, InitialContext ctx) throws JMSException, NamingException 
	{	
