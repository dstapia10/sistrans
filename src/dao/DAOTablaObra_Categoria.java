...
public class DAOTablaObra_Categoria {
	...
	public ArrayList<Obra_Categoria> darObrasCategorias() throws SQLException, Exception {
...
//		return actores;
	...
	public ArrayList<Obra_Categoria> buscarObrasCategoriasPorIdObra(int idObra) throws SQLException, Exception {
//		ArrayList<Actor> actores = new ArrayList<Actor>();
//
...
//		return actores;
	...
	public ArrayList<Obra_Categoria> buscarObrasCategoriasPorIdCategoria(int idCategoria) throws SQLException, Exception {
//		ArrayList<Actor> actores = new ArrayList<Actor>();
//
//		String sql = "SELECT * FROM ACTOR WHERE CEDULA ='" + cedula2 + "'";
//
...
//		return actores;
	...
	public void addObraCategoria(Obra_Categoria obraCategoria) throws SQLException, Exception {
...
//		prepStmt.executeQuery();
	...
	public void updateObraCategoria(Obra_Categoria obraCategoriar) throws SQLException, Exception {
...
//		prepStmt.executeQuery();
	...
	public void deleteObraCategoria(Obra_Categoria obraCategoria) throws SQLException, Exception {
