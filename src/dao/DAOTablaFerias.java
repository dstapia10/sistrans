...
public class DAOTablaFerias {
	 ...
	 */
	public ArrayList<Actor> darVideos() throws SQLException, Exception {
		ArrayList<Actor> videos = new ArrayList<Actor>();
		...
		while (rs.next()) {
			...
			videos.add(new Actor(id, name, duration));
		}
		return videos;
	}
	 ...
	 * @throws Exception - Cualquier error que no corresponda a la base de datos
	 */
	public ArrayList<Actor> buscarVideosPorName(String name) throws SQLException, Exception {
		ArrayList<Actor> videos = new ArrayList<Actor>();
		...
		while (rs.next()) {
			...
			videos.add(new Actor(id, name2, duration));
		}
	 ...
	 * @throws Exception - Cualquier error que no corresponda a la base de datos
	 */
	public void addVideo(Actor video) throws SQLException, Exception {
	 ...
	 * @throws Exception - Cualquier error que no corresponda a la base de datos
	 */
	public void updateVideo(Actor video) throws SQLException, Exception {
	 ...
	 * @throws Exception - Cualquier error que no corresponda a la base de datos
	 */
	public void deleteVideo(Actor video) throws SQLException, Exception {
	 ...
	 * @throws Exception - Cualquier error que no corresponda a la base de datos
	 */
	public ArrayList<Actor> darVideoMasAlquilado()  throws SQLException, Exception {
		ArrayList<Actor> videos = new ArrayList<Actor>();
