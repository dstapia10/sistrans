...
public class ExchangeMsg2 
{
	...
	public ExchangeMsg2(@JsonProperty(value="routingkey") String queue, @JsonProperty(value="sender") String sender, @JsonProperty(value="payload") String payload, 
						@JsonProperty(value="status") String status, @JsonProperty(value="msgId") String msgId, @JsonProperty(value="idCompañia") int idCompañia) 
	{
	...
	public void setIdCompañia(int usuario) {
		this.idCompañia = usuario;
	}
